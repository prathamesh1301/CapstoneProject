...
def png_to_ogm(filename=r'C:\Users\Admin\OneDrive\Desktop\Capstone Project\images\obs.png', normalized=False, origin='lower'):
    """
...
def plot_path(path):
    ...
    plt.savefig('image_plot.png',dpi=100)
    plt.show()
